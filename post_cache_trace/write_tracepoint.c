...
#define MY_MODULE "post_cache_write_tracepoint"

#define MAX_SYMBOL_LEN 64
static char symbol[MAX_SYMBOL_LEN] = "ext4_io_submit";
static char symbol2[MAX_SYMBOL_LEN] = "ext4_writepage";
...
static int handler_pre(struct kprobe *p, struct pt_regs *regs) {
	...
	offset = io->io_bio->bi_io_vec[0].bv_page->index;
	size = io->io_bio->bi_iter.bi_size;
    }
    else {
	id = 2;
	f_inode = page->mapping->host;
